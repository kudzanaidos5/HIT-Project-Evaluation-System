...
export default function DashboardPage() {
  ...
  const { projects, averages, completionRate, isLoading, error } = useDashboardData()
    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Welcome back, {user?.name}! Here's an overview of your project evaluation system.
        </p>
      </div>
                    ...
                    <div key={project.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-md">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Level {project.level} • {project.course_name || 'Unknown Course'}
                        </p>
                      </div>
