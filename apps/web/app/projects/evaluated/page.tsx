...
export default function EvaluatedProjectsPage() {
  const { isDarkMode } = useThemeStore()
  const { data: projectsData, isLoading, error } = useProjects()
  const [searchTerm, setSearchTerm] = useState('')

  // Filter only evaluated projects
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-red-700">
                <p>Unable to load evaluated projects. Please try refreshing the page.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <ol className="flex items-center space-x-4">
            ...
            <li>
              <div className="flex items-center">
                ...
                <span className="ml-4 text-sm font-medium text-gray-500 dark:text-gray-400">Evaluated Projects</span>
              </div>
            </li>
          </ol>
        </nav>
        <h1 className="mt-2 text-3xl font-bold text-gray-900 dark:text-gray-100">Evaluated Projects</h1>
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-6">
        <div className="max-w-md">
          <label htmlFor="search" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            Search Evaluated Projects
          </label>
          <input
            type="text"
            id="search"
            placeholder="Search by project title, student, or study program..."
            value={searchTerm}
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">
              Evaluated Projects ({evaluatedProjects.length})
            </h3>
            <Link
              href="/analytics"
        ...
        {isLoading ? (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center">
                      ...
                      <span className="ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400">
                        Evaluated
                      </span>
                    </div>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No evaluated projects</h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {searchTerm 
                ? 'No evaluated projects match your search criteria.'
